...
class Student : virtual public Person {
	private :
		...
		public :
			...
			void printPerson(ostream& os) override {
			...
			void inputPerson(istream& is) override {
...
int main() {
	...
	Student s0;
	Teacher t0;
	TeachingAssistant ta0;
	
    cout<<"Enter information for a person"<<endl; cin>>p0;
	cout<<endl<<"---Person Information---"<<endl;
    cout<<p0;
    cout<<endl; 
    
    cout<<"Enter information for a student"<<endl; cin>>s0; 
	cout<<endl<<"---Student Information---"<<endl;
    cout<<s0;
    cout<<endl; 
    
    cout<<"Enter information for a teacher"<<endl; cin>>t0;
	cout<<endl<<"---Teacher Information---"<<endl;
    cout<<t0;
    cout<<endl; 
    
    cout<<"Enter information for a teaching assistant"<<endl; cin>>ta0;
	cout<<endl<<"---Teaching Assistant Information---"<<endl; 
    cout<<ta0;
    cout<<endl; 
}
